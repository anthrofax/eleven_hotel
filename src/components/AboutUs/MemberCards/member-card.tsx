...
function MemberCard({ memberId }: { memberId: string }) {
  ...
  return (
    <div className="cursor-pointer flex flex-col w-[80%] max-w-sm h-fit bg-tertiary-superLight dark:bg-tertiary-light rounded-xl py-4 hover:border-4 border-secondary transition-all">
      ...
      <div className="flex items-center justify-center flex-col p-1 text-center">
        <h3 >{currentMember.nama}</h3>
        <p >{currentMember.peran}</p>
      </div>
